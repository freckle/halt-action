...
async function handlePullRequest(
  ...
  const changes = await getChangesInPullRequest(client, github.context, pullRequest)
...
async function sendSlackNotifications(inputs: Inputs, msg?: Message): Promise<void> {
